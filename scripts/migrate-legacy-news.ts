...
const entries: MigrationEntry[] = [
  {
    ...
    category: '最新动态',
    tags: ['新年贺词'],
    cover: '/visuals/news/new-year-greeting-2024-square.jpg',
  },
  {
    ...
    category: '最新动态',
    tags: ['公示公告'],
    cover: '/visuals/news/feature-sunset-2025-square.jpg',
  },
  {
    ...
    category: '最新动态',
    tags: ['任前公示'],
    cover: '/visuals/news/appointment-2025-square.jpg',
  },
  {
    ...
    category: '最新动态',
    tags: ['公示公告'],
    cover: '/visuals/news/authorization-withdrawal-2025-square.jpg',
  },
  {
    ...
    category: '最新动态',
    tags: ['新年贺词'],
    cover: '/visuals/news/new-year-progress-2026-square.jpg',
  },
  {
    ...
    category: '最新动态',
    tags: ['对外投资'],
    cover: '/visuals/news/investment-forward-2026-square.jpg',
  },
  {
